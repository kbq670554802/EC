...
import com.xike.kbq.core.delegates.web.route.RouteKeys;
...
public abstract class WebDelegate extends KbqDelegate implements IWebViewInitializer {

    private WebView mWebView = null;
    private final ReferenceQueue<WebView> WEB_VIEW_QUEUE = new ReferenceQueue<>();
    private String mUrl = null;
    private boolean mIsWebViewAvailable = false;
    private KbqDelegate mTopDelegate = null;
    ...
    public void setTopDelegate(KbqDelegate delegate) {
        mTopDelegate = delegate;
    }

    public KbqDelegate getTopDelegate() {
