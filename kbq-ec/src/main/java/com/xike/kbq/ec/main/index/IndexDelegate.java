...
import com.xike.kbq.ec.main.index.search.SearchDelegate;
import com.xike.kbq.ui.recycler.BaseDecoration;
import com.xike.kbq.ui.refresh.RefreshHandler;
...
public class IndexDelegate extends BottomItemDelegate implements View.OnFocusChangeListener {
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        initRefreshLayout();
        initRecyclerView();
        mRefreshHandler.firstPage("index.php?debug=" + R.raw.index_data);
    }
