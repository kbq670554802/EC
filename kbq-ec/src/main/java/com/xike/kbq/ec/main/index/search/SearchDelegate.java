...
public class SearchDelegate extends KbqDelegate {
    ...
    private void saveItem(String item) {
        if (!StringUtils.isEmpty(item) && !StringUtils.isSpace(item)) {
            ...
            final String historyStr =
                    KbqPreference.getCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY);
            ...
            KbqPreference.addCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY, json);
        }
    }
