...
public class FastPay implements View.OnClickListener {
    ...
    private FastPay(KbqDelegate delegate) {
        this.mActivity = delegate.getProxyActivity();
        this.mDialog = new AlertDialog.Builder(delegate.getContext()).create();
    }

    public static FastPay create(KbqDelegate delegate) {
...
//                        payAsyncTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, paySign);
    ...
    private void weChatPay(int orderId) {
        ...
        KbqLogger.d("WX_PAY", weChatPrePayUrl);

        final IWXAPI iwxapi = KbqWeChat.getInstance().getWXAPI();
        final String appId = Kbq.getConfiguration(ConfigKeys.WE_CHAT_APP_ID);
